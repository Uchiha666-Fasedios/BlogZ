...
{{--fin nuevo--}}
  ...
  {{--<script src="https://cdnjs.cloudflare.com/ajax/libs/typeahead.js/0.11.1/bloodhound.min.js"></script>--}}{{--libreria para q se desplege en elbuscador dicha caja de busqeda--}}
