                    ...
                    <div class="container">
                        <div class="card cart-block">
                            ...
                            <div class="col-xs-6 padding-left-0 padding-right-0">
                                ...
                                <div class="card-img iconbox"><a href="#" data-toggle="modal" data-target="#ventanaModal1"><img src="{{  url('http://www.adrianweb.live/storage/php.jpg') }}" alt="php"></a></div> 
                            </div>
                            <div class="col-xs-6 padding-left-0 padding-right-0">
                    ...
                    <div class="container">
                        <div class="card cart-block">
                            ...
                            <div class="col-xs-6 padding-left-0 padding-right-0">
                               ...
                               <div class="card-img iconbox"><a href="#" data-toggle="modal" data-target="#ventanaModal2"><img src="{{  url('http://www.adrianweb.live/storage/mysql.jpg') }}" alt="php"></a></div>
                            </div>
                            <div class="col-xs-6 padding-left-0 padding-right-0">
                                <div class="text-xs-left">
                ...
                <div class="mbr-cards-col col-xs-12 col-lg-5">
                    <div class="container">
                        <div class="card cart-block">
                            ...
                            <div class="col-xs-6 padding-left-0 padding-right-0">
                            <div class="card-img iconbox"><a href="#" data-toggle="modal" data-target="#ventanaModal3"><img src="{{  url('http://www.adrianweb.live/storage/jquery.jpg') }}" alt="php"></a></div>
                            </div>
                            <div class="col-xs-6 padding-left-0 padding-right-0">
                                <div class="text-xs-left">
                ...
                <div class="mbr-cards-col col-xs-12 col-lg-5 col-lg-offset-1">
                    <div class="container">
                        <div class="card cart-block">
                            ...
                            <div class="col-xs-6 padding-left-0 padding-right-0">
                            <div class="card-img iconbox"><a href="#" data-toggle="modal" data-target="#ventanaModal4"><img src="{{  url('http://www.adrianweb.live/storage/css2.jpg') }}" alt="php"></a></div>
                            </div>
                            <div class="col-xs-6 padding-left-0 padding-right-0">
                                <div class="text-xs-left">
