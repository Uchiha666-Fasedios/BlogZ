...
$user=$options['empty_data'];//lo recibe del controlador q es el objeto user
        ...
        ->add('receiver', EntityType::class, array( //este input es de typo select 
            'class' => 'BackendBundle:User', //aca pongo de donde voy a seleccionar en estecaso porqe voy a usar una query para sacar los usuarios  .. si no le pongo lo q yo quiera.. 
