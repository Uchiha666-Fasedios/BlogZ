...
$publications= $this->getPublications($request);
            ...
            return $this->render('AppBundle:Publication:home.html.twig', Array( //me voy a esta vista llevandome la variable para mostrarla ahi
...
public function getPublications($request){
    $em = $this->getDoctrine()->getManager();// esto me va permitir trabajar con las entidades y guardar en la base de datos
    $user =  $this->getUser();//getUser() me trae el usuario logeado
    $publications_repo = $em->getRepository("BackendBundle:Publication");//getRepository me trae todos los metodos de consulta q tiene el modelo por defecto mas los q yo alla añadido si le configuro un repositorio
