...
use BackendBundle\Entity\PrivateMessage;//mi entidad de User 
...
$em->persist($private_message);// persist Guardar objeto en doctrine q doctrine es una memoria temporal
            ...
            $private_message=$this->getPrivateMessages($request);


            $this->setReaded($em ,$user);//esta funcion cambia el estado de los mensages

        return $this->render('AppBundle:PrivateMessage:index.html.twig', Array( //me voy a esta vista llevandome la variable para mostrarla ahi
