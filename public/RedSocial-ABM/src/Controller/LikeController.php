...
use App\Entity\Like;//mi entidad de User
...
//el primer parametro saco el usuario de la publicaion q se le dio like el 2 le meto el string de like el 3 el id del usuario logeado q le dio like y el 4 me guarda el id del usuario de la notificacion q se le dio like
    ...
    public function unlike($id = null){
        ...
        $like_repo = $em->getRepository("App:Like");//getRepository me trae todos los metodos de consulta q tiene el modelo por defecto mas los q yo alla añadido si le configuro un repositorio
    ...
    public function likes(Request $request, $nickname = null,PaginatorInterface $paginator){
        ...
        $dql= "SELECT l FROM App:Like l WHERE l.user = $user_id ORDER BY l.id DESC"; //para q me tome $user_id ay q poner comillas dobles ""
