...
$(document).ready(function () {
  ...
  ias.on('ready', function (event) {
    //ias.on('ready' ESTO ES PROPIO DE ias.on
    followButtons();
...
function followButtons() {
  $(".btn-follow").unbind('click').click(function () {
    //unbind para q no se lancen varios clik ..evento click hago click en el boton seguir
    ...
    $.ajax({
      ...
      //los datos q voy a enviar.. this hace referencia a el boton click
      type: 'POST',
