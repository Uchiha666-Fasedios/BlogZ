					...
					<form method="POST" action="{{route('video.save')}}" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<div class="col-md-7"><?php //col-md-7 el tamaño de la caja para q entre el texto ?>
								<input id="video_path" type="file" name="video_path" class="form-control {{ $errors->has('video_path') ? 'is-invalid' : '' }}" required/><?php //class="form-control para q este mejor esterilizado con boostrap ?>
