    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
          ...
          <?php //formulario para editar la imagen ?>
					...
					<form method="POST" action="{{ route('image.update') }}" enctype="multipart/form-data"><?php //aca le indico a donde van los datos  ?>
						@csrf
						...
						<div class="form-group row">
							...
							<div class="col-md-7">
								@if($image->user->image)<?php //$image va al metodo user de la clase Image y hago relacion con tabla user y tabla images gracias a ORM y puedo sacar las propiedades de estas tablas que tengan smejanza con el id de(user) y user_id de(images)?>
